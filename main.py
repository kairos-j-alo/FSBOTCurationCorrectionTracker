     ...
     try:
         ...
         # Handle POST requests (original functionality)
             ...
             if bot.loop and bot.loop.is_running():
                 ...
                 # The call_soon_threadsafe is often used to wake up the loop if it's
                 # waiting on I/O, ensuring it processes newly added tasks promptly.
                 # Passing a simple lambda: None is a common idiom for this.
                 bot.loop.call_soon_threadsafe(lambda: None)
 ...
 flask_thread = Thread(target=run_flask, daemon=True) # daemon=True allows main thread to exit even if this thread is running
 flask_thread.start()
